...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function renderImgSeq(canvasID) {
        ...
        const triggerElement = isFooterCanvas ? document.querySelector(".scrub-wrapper-footer") : document.querySelector(".scrub-wrapper");
        const frameCount = 200; // set frame count variable
        /*new url loader*/ const currentFrame = (index)=>{
            // Detect screen width
            ...
            if (screenWidth < breakpoint) {
                /*IS MOBILE DEVICE*/ baseUrl = mobileBaseUrl;
                const frameUrl = `${baseUrl}/MOBI_${isFooterCanvas ? "Footer" : "RollingBall_viewport"}_9-16_${index.toString().padStart(5, "0")}.jpg`;
                return frameUrl;
            } else {
                /*IS DESKTOP DEVICE*/ baseUrl = desktopBaseUrl;
                const frameUrl = `${baseUrl}/MOBI_${isFooterCanvas ? "Footer" : "RollingBall_viewport"}_16-9_${index.toString().padStart(5, "0")}.jpg`;
                return frameUrl;
            }
        };
        const images = [];
        ...
        function resizeCanvas() {
            ...
            const aspectRatio = images[airpods.frame].width / images[airpods.frame].height;
