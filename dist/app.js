...
document.addEventListener("DOMContentLoaded", function() {
    ...
    /*new url loader*/ const currentFrame = (index)=>{
        ...
        const desktopBaseUrl = "https://general-client-assets.sfo3.digitaloceanspaces.com/MOBI/Home/Rolling_Ball/v02";
        const mobileBaseUrl = "https://general-client-assets.sfo3.digitaloceanspaces.com/MOBI/Home/Rolling_Ball/v02";
        const frameUrl = `${desktopBaseUrl}/MOBI_rollingBall_viewport${index.toString().padStart(4, "0")}.jpg`; // set frame url variable
